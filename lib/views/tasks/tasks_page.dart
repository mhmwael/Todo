...
import 'widgets/task_time_period_filter.dart';
import 'widgets/add_task_dialog.dart';

// Main tasks listing page with filtering, search, and task management
class TasksPage
    extends
        StatefulWidget {
  const TasksPage({
                          ...
                          if (pendingTasks.isEmpty &&
                            ...
                            ...pendingTasks.map(
                              (
                                ...
                                onPin: () => taskController.toggleTaskPin(
                                  task.id,
                                ),
                                onFocus: () => taskController.toggleTaskFocus(
                                  task.id,
                                ),
                                isFocused:
                                    taskController.focusedTaskId ==
                                    task.id,
                              ),
                            ),
